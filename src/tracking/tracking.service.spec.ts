...
describe('TrackingService', () => {
  ...
  it('records attributed clicks only for active offers and matching video jobs', async () => {
    ...
    prisma.videoJob.findUnique.mockResolvedValue({ id: 'job-1', offerId: 'offer-1' });
  ...
  it('rejects disabled offers and offer/job mismatches before creating clicks', async () => {
    ...
    prisma.offer.findFirst.mockResolvedValueOnce({ id: 'offer-1' });
    prisma.videoJob.findUnique.mockResolvedValueOnce({ id: 'job-1', offerId: 'other-offer' });
