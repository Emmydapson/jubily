...
export function topicToNicheCandidates(topicTitle: string): string[] {
  ...
  const map: Array<[string, string[]]> = [
    ['HEALTH_WELLNESS', ['sleep', 'wellness', 'health', 'supplement', 'nutrition', 'gut', 'digestion', 'dental', 'joint', 'hearing']],
    ['FINANCE', ['finance', 'budget', 'invest', 'credit', 'bank', 'money', 'trading']],
    ['AI_SOFTWARE', ['ai', 'software', 'automation', 'saas', 'tool', 'app']],
    ['TECHNOLOGY', ['tech', 'gadget', 'device', 'laptop', 'phone']],
    ['BUSINESS', ['business', 'startup', 'sales', 'crm', 'entrepreneur']],
    ['EDUCATION', ['course', 'learn', 'training', 'education', 'lesson']],
    ['FITNESS', ['fitness', 'workout', 'exercise', 'gym', 'strength']],
    ['BEAUTY', ['beauty', 'skin', 'makeup', 'hair', 'cosmetic']],
    ['TRAVEL', ['travel', 'flight', 'hotel', 'luggage', 'trip']],
    ['GAMING', ['gaming', 'game', 'controller', 'console', 'streaming']],
    ['ECOMMERCE', ['ecommerce', 'store', 'shop', 'product', 'deal']],
    ['REAL_ESTATE', ['real estate', 'property', 'housing', 'mortgage']],
    ['PARENTING', ['parent', 'baby', 'kids', 'family']],
    ['PETS', ['pet', 'dog', 'cat', 'puppy']],
    ['PERSONAL_DEVELOPMENT', ['focus', 'mindset', 'productivity', 'habit', 'confidence']],
    ['FOOD', ['food', 'recipe', 'cooking', 'kitchen']],
    ['FASHION', ['fashion', 'style', 'clothing', 'outfit']],
    ['HOME_GARDEN', ['home', 'garden', 'desk', 'furniture', 'decor']],
    ['AUTOMOTIVE', ['car', 'auto', 'vehicle', 'truck']],
    ['DIY', ['diy', 'repair', 'build', 'tool']],
    ['RELATIONSHIPS', ['relationship', 'dating', 'marriage']],
    ['SPIRITUALITY', ['spiritual', 'faith', 'meditation']],
  ];
