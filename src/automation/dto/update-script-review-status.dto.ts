...
export const SCRIPT_REVIEW_STATUSES = [
  'APPROVED',
  'NEEDS_REVIEW',
  'REJECTED',
] as const;
...
export class UpdateScriptReviewStatusDto {
  @ApiPropertyOptional({
    ...
    example: 'APPROVED',
    description:
      'Admin review decision. APPROVED allows automatic render and publish.',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Optional admin review note stored in qualityReview.adminNote.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(1000)
