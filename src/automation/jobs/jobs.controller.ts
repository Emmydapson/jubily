...
export class JobsController {
  ...
  @Get()
  @ApiOperation({ summary: 'List video jobs', description: 'Admin-only endpoint.' })
  ...
  @Get('summary')
  @ApiOperation({ summary: 'Get failed job summary', description: 'Admin-only endpoint.' })
  ...
  @Get('workers/status')
  @ApiOperation({ summary: 'Get worker status', description: 'Admin-only endpoint.' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get a video job by ID', description: 'Admin-only endpoint.' })
  ...
  @Get(':id/assets')
  @ApiOperation({ summary: 'Get video job assets', description: 'Admin-only endpoint.' })
  @ApiParam({ name: 'id', format: 'uuid', example: '4f4b01d4-1d0b-43fd-84bc-ecf162b3f05c' })
  ...
  // jobs.controller.ts
@Post('run-slot')
@ApiOperation({ summary: 'Run a schedule slot manually', description: 'Admin-only endpoint.' })
...
runSlot(@Body() body: RunSlotDto) {
  ...
  @Post(':id/cancel')
  @ApiOperation({ summary: 'Cancel a video job', description: 'Admin-only endpoint. Clears worker leases and prevents further retries.' })
  @ApiParam({ name: 'id', format: 'uuid', example: '4f4b01d4-1d0b-43fd-84bc-ecf162b3f05c' })
  ...
  @ApiOperation({ summary: 'Reset a failed video job render', description: 'Admin-only endpoint. Only failed jobs can be reset.' })
  @ApiParam({ name: 'id', format: 'uuid', example: '4f4b01d4-1d0b-43fd-84bc-ecf162b3f05c' })
  ...
  // optional: retry
  @Post(':id/retry')
  @ApiOperation({ summary: 'Retry a failed video job', description: 'Admin-only endpoint.' })
  @ApiParam({ name: 'id', format: 'uuid', example: '4f4b01d4-1d0b-43fd-84bc-ecf162b3f05c' })
